...
namespace DuiLib {
	...
	public:
		...
		virtual bool IsBorderWithFill() const;
		virtual void SetBorderWithFill(bool border_with_fill);
		...
		virtual void SetAlign(LPCTSTR align_value);
	public:
		CEventSource OnInit;
	...
	protected:
		...
		bool m_bRichEvent;
		bool m_bDragEnabled;
		bool m_bBorderWithFill; // 绘制边框的同时填充颜色
		bool m_bDropEnabled;
